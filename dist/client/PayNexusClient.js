...
export class PayNexusClient extends PayNexusEventEmitter {
    ...
    constructor(config) {
        ...
        this.httpClient = new HttpClient(config.secretKey, baseUrl, timeout, retries, logLevel, config.httpClient, config.publicKey);
...
//# sourceMappingURL=PayNexusClient.js.map